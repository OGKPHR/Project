...
function updateCart() {
    ...
    cartItems.forEach((item, index) => {
        ...
        deleteBtn.textContent = 'ลบ'; // Change "Delete" to Thai (ลบ)
    ...
    addToCartButtons.forEach((button, index) => {
        ...
        button.textContent = isProductInCart(productName) ? 'อยู่ในตะกร้า' : 'ใส่ในตะกร้า'; // Change "Add to Cart" to Thai (ใส่ในตะกร้า)
    });
}
